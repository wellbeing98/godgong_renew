        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(pathReference == null){
                    Toast.makeText(StudyActivity.this, "저장소에 사진이 없습니다.", Toast.LENGTH_SHORT).show();}
                else{
                    Toast.makeText(StudyActivity.this, "저장소에 사진이 있습니다.", Toast.LENGTH_SHORT).show();


                    StorageReference submitProfile = storageReference.child("images/"+email);


                    Glide.with(StudyActivity.this /* context */)
                            .load(submitProfile)
                            .into(im_project);
                }
            }
        ...
        ValueEventListener registerListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot commentSnapshot : snapshot.getChildren()) {
                    ...
                    LayoutInflater layoutInflater = LayoutInflater.from(StudyActivity.this);
...
//                    imm.hideSoftInputFromWindow(comment_et.getWindowToken(), 0);
                ...
                // 토스트메시지 출력
                Toast.makeText(StudyActivity.this, "프로젝트에 참여되었습니다.", Toast.LENGTH_SHORT).show();
...
//            }
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(StudyActivity.this, "프로젝트에 참여를 취소하였습니다.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        chat_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StudyActivity.this, ChatActivity.class);
